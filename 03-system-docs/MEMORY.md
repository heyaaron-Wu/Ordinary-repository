...
1. **生成复盘报告** → `08-fund-daily-review/reviews/YYYY-MM-DD.md`
2. **更新状态文件** → `08-fund-daily-review/state.json`
3. **更新交易账本** → `08-fund-daily-review/ledger.jsonl`
4. **Git 提交并推送**
...
# 添加文件
git add 08-fund-daily-review/reviews/YYYY-MM-DD.md
